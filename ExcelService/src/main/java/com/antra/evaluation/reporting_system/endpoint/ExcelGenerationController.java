...
//        }
    ...
    public ResponseEntity<ErrorResponse> FileCannotBeDelete(Exception e) {
        log.error("The file cannot be deleted", e);
        return new ResponseEntity<>(new ErrorResponse("Cannot Delete File", HttpStatus.INTERNAL_SERVER_ERROR), HttpStatus.INTERNAL_SERVER_ERROR);
    }
